CEAMS
-----
CEAMS, the API management product based on CDIF framework now can be freely downloaded & installed from [our web site](https://www.apemesh.com/cn/download), or using below convenience script:

```
curl -sL https://www.apemesh.com/download/get-ceams.sh | sudo -E bash -
```
on Debian / Ubuntu or RHEL / CentOS based Linux OS. Please refer to the above download page for more details.
