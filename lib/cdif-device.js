    ...
    this._connect(user, pass, function(error, redirectObj) {
      ...
      if (redirectObj) {
        if (typeof(redirectObj) !== 'object') {
          return callback(new DeviceError('redirect url malform, not an object'), null, null);
        }
        if (redirectObj.href == null || redirectObj.method == null) {
          return callback(new DeviceError('redirect url malform, no valid field'), null, null);
        }
