...
CdifDevice.prototype.setDeviceTimeout = function(callback) {
  if (this.timeout == null) {
    this.addListener('norespond', function() {
      delete this.timeout;
      this.removeAllListeners('norespond');
      this.connected = false;
      this.connections = 0;
      callback();
    }.bind(this));
    ...
    this.timeout = timeout.expire.bind(this);
    setTimeout(this.timeout, 20000);
  }
};

CdifDevice.prototype.clearDeviceTimeout = function() {
  if (this.timeout != null) {
